$(document).ready(function() {
  ...
  Array.from(comics).forEach(function(comic){
    /* <div class="comicContainer" id=number style="text-align: center; width: 100%;">
         <div class="cTitle" style="text-align: center;">title</div>
         <div class="comic">
    ...
    */
    ...
    var element = '<div class="comicContainer" id="' + number + '" style="text-align: center; width: 100%;"><div class="cTitle" style="text-align: center;">' + title + '</div>' +
